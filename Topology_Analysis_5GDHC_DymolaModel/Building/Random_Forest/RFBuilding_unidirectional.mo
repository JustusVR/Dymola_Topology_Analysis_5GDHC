...
public
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_Cool(
    ...
    tableName="tab1",
    fileName=
        "/home/justus/Documents/Topology_Analysis_5GDHC/Resources/Loads/LookUp_Table/cooling_ambient.mos")
...
equation
  ...
  connect(pump_Cool.port_a, del_A.ports[2]) annotation (Line(points={{-150,
          -190},{-198,-190},{-198,-8},{-198,-8},{-198,8},{-202,8},{-202,20}},
        color={0,127,255}));
