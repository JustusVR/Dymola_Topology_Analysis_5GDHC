...
model RFBuilding_unidirectional_dyn
...
public
  Modelica.Blocks.Continuous.Integrator EPumps(y(unit="J"))
    ...
    annotation (Placement(transformation(extent={{160,268},{180,288}})));
equation
  ...
  connect(cool.port_b, del1.ports[3]) annotation (Line(points={{24,-191},{
          242.667,-191},{242.667,18}},
                               color={0,127,255}));
  ...
  connect(cool.Q_flow, Qflow_cool) annotation (Line(points={{26.4,-177.2},{218.2,
          -177.2},{218.2,-262},{290,-262}}, color={0,0,127}));
  ...
  connect(add.y, EPumps.u) annotation (Line(points={{125,240},{142,240},{142,
          278},{158,278}}, color={0,0,127}));
  annotation (
    ...
    Icon(coordinateSystem(extent={{-280,-300},{280,300}}), graphics={Rectangle(
      ...
      Polygon(
        ...
        Ellipse(
          ...
          fillColor={135,135,135},
          fillPattern=FillPattern.Solid)}));
end RFBuilding_unidirectional_dyn;
