...
public
  Modelica.Fluid.Interfaces.FluidPort_a port_a(
    ...
    annotation (Placement(transformation(extent={{-10,10},{10,-10}},rotation=180,origin={-80,-300})));
...
protected
  ...
  Modelica.Blocks.Sources.RealExpression ExpEleHP(y=1)
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={80,250})));
  Modelica.Blocks.Sources.RealExpression ExpQflow_heat(y=heatingLoad.I_Load)
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={140,250})));
  Modelica.Blocks.Sources.RealExpression EXPQflow_cool(y=coolingLoad.I_Load)
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={200,250})));
...
equation
  ...
  connect(pump_cool.port_a, del_A.ports[2]) annotation (Line(points={{-90,-140},
          {-240,-140},{-240,1.77636e-15},{-230,1.77636e-15}},
        color={0,127,255}));
  ...
  connect(pump_cool.port_b, cool.port_a) annotation (Line(points={{-70,-140},{-20,
          -140}},                       color={0,127,255}));
  connect(cool.port_b, del_B.ports[2]) annotation (Line(points={{20,-140},{238,-140},{238,-2},{230,-2},{230,-4.44089e-16}},
                               color={0,127,255}));
  ...
  connect(port_a, valve_a.port_b)
    annotation (Line(points={{-80,-300},{-80,-280},{-130,-280}},
                                                      color={0,127,255}));
  connect(valve_a.port_a, del_A.ports[3]) annotation (Line(points={{-150,-280},{-258,-280},{-258,0},{-228,0},{-228,-2.66667},{-230,-2.66667}},
                                                       color={0,127,255}));
  ...
  connect(buildingConnected.y, coolingLoad.u)
    annotation (Line(points={{-156.8,0},{-140.5,0},{-140.5,-80},{-124,-80}},   color={255,0,255}));
  ...
  connect(port_b, valve_b.port_a)
    annotation (Line(points={{80,-300},{80,-280},{130,-280}},
                                                    color={0,127,255}));
  connect(valve_b.port_b, del_B.ports[3]) annotation (Line(points={{150,-280},{260,-280},{260,2.66667},{230,2.66667}},
                                              color={0,127,255}));
