...
protected
  Modelica.Blocks.Tables.CombiTable2D    LookUp_DQ_Load(
    tableOnFile=true,
    tableName="tab1",
    fileName=DQ_FileName) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-30,-60})));
public
...
equation
  ...
  connect(LookUp_HP_ele.y[1], add.u1) annotation (Line(points={{-19,-20},{-12,-20},
          {-12,-8},{0,-8},{0,66},{18,66}},     color={0,0,127}));
  ...
  connect(modTim.y, LookUp_DQ_Load.u1) annotation (Line(points={{-54.5,-40},{
          -48,-40},{-48,-54},{-42,-54}},
                                color={0,0,127}));
  connect(T_Inlet, LookUp_DQ_Load.u2) annotation (Line(points={{-120,-60},{-70,
          -60},{-70,-66},{-42,-66}},
                                color={0,0,127}));
  connect(T_Inlet, LookUp_HP_ele.u2) annotation (Line(points={{-120,-60},{-70,
          -60},{-70,-26},{-42,-26}}, color={0,0,127}));
