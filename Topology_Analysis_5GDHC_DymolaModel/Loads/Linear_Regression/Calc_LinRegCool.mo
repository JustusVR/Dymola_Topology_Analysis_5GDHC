...
equation
  ...
  power.u =
    Topology_Analysis_5GDHC_DymolaModel.Loads.Linear_Regression.ext_func_cool_Q(
    {1,dayIntCorrected.y,hourInt.y,monthInt.y,mFlow,tInletC.y,humOut,tOutsideC.y});
  coolEleHP =
    Topology_Analysis_5GDHC_DymolaModel.Loads.Linear_Regression.ext_func_cool_P(
    {1,dayIntCorrected.y,hourInt.y,monthInt.y,mFlow,tInletC.y,humOut,tOutsideC.y});
  coolTOutlet =
    Topology_Analysis_5GDHC_DymolaModel.Loads.Linear_Regression.ext_func_cool_T(
    {1,dayIntCorrected.y,hourInt.y,monthInt.y,mFlow,tInletC.y,humOut,tOutsideC.y});
