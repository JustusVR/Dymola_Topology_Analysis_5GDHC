within Topology_Analysis_5GDHC_DymolaModel.DES.Old;
model Heat_Pump
  extends Topology_Analysis_5GDHC_DymolaModel.DES.Base_Classes.DES_TA_Interface;

  Buildings.Experimental.DistrictHeatingCooling.Plants.HeatingCoolingCarnot_T heatingCoolingCarnot_T(
...
equation
  ...
  connect(heatingCoolingCarnot_T.QCoo_flow, Q_C_flow) annotation (Line(points={{-66,18},
          {-120,18},{-120,-200},{290,-200}},      color={0,0,127}));
