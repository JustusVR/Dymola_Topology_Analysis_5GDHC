...
model DH_Compare_OpenStudio_RF_noDyn
...
parameter Real R_nominal(unit="Pa/m") = 100 "Pressure drop per meter at nominal flow rate";
  ...
  Building.Random_Forest.RFBuilding_unidirectional_noDyn linRegBuilding(
      redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{-348,-28},{-292,32}})));
  Building.Random_Forest.RFBuilding_unidirectional_noDyn linRegBuilding1(
      redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{-188,-30},{-132,30}})));
  Building.Random_Forest.RFBuilding_unidirectional_noDyn linRegBuilding2(
      redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{-28,-30},{28,30}})));
  Building.Random_Forest.RFBuilding_unidirectional_noDyn linRegBuilding3(
      redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{132,-30},{188,30}})));
  Building.Random_Forest.RFBuilding_unidirectional_noDyn linRegBuilding4(
      redeclare package Medium = Medium)
...
equation
  ...
  connect(SumPumps.u[5], linRegBuilding.elePumps) annotation (Line(points={{460,
          356.64},{460,362},{422,362},{422,362},{-280,362},{-280,26},{-291,26}},
                        color={0,0,127}));
  ...
  annotation (
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-660,-320},{660,
            420}})));
end DH_Compare_OpenStudio_RF_noDyn;
