...
model DH_Compare_OpenStudio_RF_noDynPr_TempSens
...
equation
  ...
  connect(HeaterChiller.port_a, pSet1.ports[1]) annotation (Line(points={{
        ...
        color={0,127,255}));
  connect(const.y, HeaterChiller.T_set) annotation (Line(points={{-631,0},{
          -600,0},{-600,-0.285714},{-557.231,-0.285714}},  color={0,0,127}));
  ...
  connect(HeaterChiller.port_b, pip0.port_a) annotation (Line(points={{
          -534.615,25.6714},{-536.308,25.6714},{-536.308,80},{-460,80}},
                                                                color={0,127,
          255}));
  ...
  connect(Inlet_Temp_plant.port, HeaterChiller.port_a) annotation (Line(
        points={{-618,-42},{-536,-42},{-536,-19.6714},{-534.615,-19.6714}},
        color={0,127,255}));
  connect(Outlet_Temp_plant.port, HeaterChiller.port_b) annotation (Line(
        points={{-620,60},{-536,60},{-536,25.6714},{-534.615,25.6714}}, color=
         {0,127,255}));
  annotation (
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-660,-320},{660,
            420}})));
end DH_Compare_OpenStudio_RF_noDynPr_TempSens;
