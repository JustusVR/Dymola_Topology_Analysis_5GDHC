...
public
  ...
  Loads.Random_Forest.Calc_RFHeat_py      Calc
...
equation
  connect(weaDat.weaBus,weaBus)  annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(calTim.month, Calc.month) annotation (Line(points={{-65,62.6},{-54,
          62.6},{-54,9.5},{-22.6667,9.5}}, color={255,127,0}));
  connect(calTim.hour, Calc.hour) annotation (Line(points={{-65,68.2},{-52,68.2},
          {-52,16},{-22.6667,16}},       color={255,127,0}));
  connect(calTim.weekDay, Calc.day) annotation (Line(points={{-65,57},{-48,57},
          {-48,22.5},{-22.6667,22.5}}, color={255,127,0}));
  ...
  connect(weaBus.relHum, Calc.humOut) annotation (Line(
      ...
      index=-1,
      extent={{-6,3},{-6,3}}));
  connect(const.y, Calc.mFlow) annotation (Line(points={{-75,4},{-56,4},{-56,3},
          {-22.6667,3}},    color={0,0,127}));
  connect(const1.y, Calc.tInlet) annotation (Line(points={{-77,-26},{-46,-26},{
          -46,-3.5},{-22.6667,-3.5}},  color={0,0,127}));
  connect(Calc.heatDemand, gain.u) annotation (Line(points={{42.9,15.8375},{
          65.45,15.8375},{65.45,16},{82,16}}, color={0,0,127}));
