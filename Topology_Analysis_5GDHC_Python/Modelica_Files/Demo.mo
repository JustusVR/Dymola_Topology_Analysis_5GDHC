...
#  NODE_A : ﻿ annotation (Placement(transformation(extent={{-3,-3},{3,3}},rotation = 0, origin = {-85,43})));
# ﻿ DUAL PIPE : annotation (Placement(transformation(extent={{-5,-5},{5,5}},rotation = 0, origin = {-30,130})));
#  ﻿  connect(Medium_Office_node_a.ports[2], Pipe_Medium_Office_Retail.port_a_hot)
#        annotation (Line(points={{-84.4,40},{-84.4,20},{-40,20},{-40,132},{-36,132},{-36,132},{-36,132.5},{-35.1,132.5}}, color={0,127,255}));

    #﻿  connect(Pipe_Medium_Office_Retail.port_b_cold, Retail_node_b.ports[2])
    #annotation (Line(points={{-25,127},{40,127},{40,20},{86,20},{86,40}}, color={0,127,255}));
    #connect(Pipe_Medium_Office_Retail.port_b_hot, Retail_node_a.ports[2])
    #annotation (Line(points={{-25,132},{40,132},{40,20},{75,20},{75,40}}, color={0,127,255}));


    #return pathPoints(points)

Diagram(coordinateSystem(extent={{-200,-200},{200,200}})), Icon(coordinateSystem(extent={{-100,-120},{160,100}})));