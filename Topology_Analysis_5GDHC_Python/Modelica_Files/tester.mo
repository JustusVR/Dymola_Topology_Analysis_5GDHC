...
model RFBuilding_unidirectional_automated
  Connector.Connector connector_a1 (redeclare final package Medium = Medium, h_outflow(start=Medium.h_default))
    annotation (Placement(transformation(extent={{-280,-310},{-260,-290}}),
        iconTransformation(extent={{-300,-20},{-260,20}})));
  Connector.Connector connector_b1 (redeclare final package Medium = Medium, h_outflow(start=Medium.h_default))
    annotation (Placement(transformation(extent={{260,-310},{280,-290}}),
        iconTransformation(extent={{-300,-20},{-260,20}})));
  Connector.Connector connector_a2 (redeclare final package Medium = Medium, h_outflow(start=Medium.h_default))
    annotation (Placement(transformation(extent={{-280,-110},{-260,-90}}),
        iconTransformation(extent={{-300,-20},{-260,20}})));
  Connector.Connector connector_b2 (redeclare final package Medium = Medium, h_outflow(start=Medium.h_default))
    annotation (Placement(transformation(extent={{260,-110},{280,-90}}),
        iconTransformation(extent={{-300,-20},{-260,20}})));
  Connector.Connector connector_a3 (redeclare final package Medium = Medium, h_outflow(start=Medium.h_default))
    annotation (Placement(transformation(extent={{-280,90},{-260,110}}),
        iconTransformation(extent={{-300,-20},{-260,20}})));
  Connector.Connector connector_b3 (redeclare final package Medium = Medium, h_outflow(start=Medium.h_default))
    annotation (Placement(transformation(extent={{260,90},{280,110}}),
        iconTransformation(extent={{-300,-20},{-260,20}})));
  Connector.Connector connector_a4 (redeclare final package Medium = Medium, h_outflow(start=Medium.h_default))
    annotation (Placement(transformation(extent={{-280,290},{-260,310}}),
        iconTransformation(extent={{-300,-20},{-260,20}})));
  Connector.Connector connector_b4 (redeclare final package Medium = Medium, h_outflow(start=Medium.h_default))
...
equation
  ...
  connect(port_a, del_A.ports[3]) annotation (Line(points={{-280,200},{-240,200},
          {-240,4},{-199.333,4},{-199.333,20}}, color={0,127,255}));
  connect(port_b, del_B.ports[3]) annotation (Line(points={{280,200},{260,200},
          {260,0},{242.667,0},{242.667,18}}, color={0,127,255}));
  annotation (
...
#def mover(pos, direction, stepSize):
    ...
    #elif direction == "d":
    #else:
    #    print "Thís direction is not valid"